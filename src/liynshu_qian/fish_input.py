...
IMAGE_SIZE=1024
NUM_EXAMPLES_PER_FOLDER=1#int(4900/2 -2)
...
def batchGenerator(image,label,batch_size,min_num,shuffle):
    ...
    return images,tf.reshape(labels,[batch_size,IMAGE_SIZE,IMAGE_SIZE])


def inputs(image_dir,label_dir,batch_size,shuffle,evall):
