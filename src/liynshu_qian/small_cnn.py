...
import small_input as fish_input
...
IMAGE_SIZE = 24#fish_input.IMAGE_SIZE
LABEL_SIZE = 24*24#fish_input.LABEL_SIZE
...
#         logits, tf.cast(labels, tf.int32), name='cross_entropy_per_example')
